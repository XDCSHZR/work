...
def LP(df, 
       cols_score, list_item, list_code_item, list_ratio_item, 
       coef_flow_shrink, 
       dict_cols_rep, 
       cols_score_group, 
       qcut_num, 
    ...
    df_res = pd.concat([df[['uid', 'group_index', 'item_score_rank', 'item', 'item_code']], 
...
if __name__ == '__main__':
    df = pd.read_csv('flow_dist/data/ugrs.txt', sep='\t', encoding='utf-8')
    cols_score = ['score_01', 'score_02', 'score_03', 'score_04', 'score_10']
    cols_score_group = ['score_01', 'score_02', 'score_03', 'score_04', 'score_10']
    list_item = ['aaa', 'bbb', 'ccc', 'ddd', 'eee']
    list_ratio_item = [0.0, 0.2, 0.4, 0.4, 0.0]
    coef_flow_shrink = 1.05
    lp_file = 'flow_dist/data/flow_test.lp'
    list_code_item = [1, 2, 3, 4, 999]
    dict_cols_rep = {
        'item': 'xxx', 
        'item_score_rank': 'xxx_score_rank', 
        'item_code': 'xxx_code'
    }
    qcut_num = [10, 10, 10, 10, 10]
    is_rule = 1
    ...
    utils.save_pickle(df_res, 'flow_dist/data/df_lp_res_test.pickle')
