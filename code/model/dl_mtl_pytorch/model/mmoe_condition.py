...
class MMOE(nn.Module):
    def __init__(self, config, feature_columns):
        ...
        self.towers = nn.ModuleList([MLPTower(self.units + self.condition_feature_columns_len, 1, self.tower_hidden_units, self.dropout, self.use_bn) for _ in range(self.num_tasks)])
