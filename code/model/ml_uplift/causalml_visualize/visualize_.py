...
def plot_all(cate=None, treatment_groups=None, treatment_test=None, y_test=None, cost_test=None, control_name='control', title='multi-treatment uplift curve',
             select_treatment_group=None,plot_qini_lift=1, is_find_best_parameters=0):
    """
    ...
    if is_find_best_parameters:
        ...
        _, auuc = plot_auuc(result, control_name='control', title=title)
        return auuc
